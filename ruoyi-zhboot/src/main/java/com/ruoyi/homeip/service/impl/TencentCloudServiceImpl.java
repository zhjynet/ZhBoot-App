...
public class TencentCloudServiceImpl implements ITencentCloudService {
    ...
    private final String SECRET_ID = configService.selectConfigByKey("tencent.cloud.secretId");
    private final String SECRET_KEY = configService.selectConfigByKey("tencent.cloud.SecretKey");

    private final String API_URL = configService.selectConfigByKey("tencent.cloud.ApiUrl");
    ...
    private DnspodClient createClient() {
        ...
        httpProfile.setEndpoint(API_URL);
